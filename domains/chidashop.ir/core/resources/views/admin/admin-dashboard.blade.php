...
@section('admin-title'){{'مدیر سایت'}}@endsection
    ...
    <div id="titlebar">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2>سلام {{'مدیر '}}<span>{{Session('full_name')}}</span></h2>
                @elseif(Session('access_type') == 2)
                    <h2>سلام {{'پشتیبان '}}<span>{{Session('full_name')}}</span></h2>
                @elseif(Session('access_type') == 3)
                    <h2>سلام {{'اپراتور '}}<span>{{Session('full_name')}}</span></h2>
                @endif
